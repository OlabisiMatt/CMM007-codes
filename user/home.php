...
<body>
        ...
        <div class="home-slide">
            <div class="wrapper">
                <div class="slide" style="background:url(../assets/images/home1.jpg) no-repeat">
                    <div class="content">
                        <h3>Welcome To Tour Palace</h3>
                        <span>enjoy your vacation to the very best</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="home-testimonial">
        <h1 class="heading-title">Tour Packages</h1>
        <div class="box-container">
    
            <div class="box">
                <div class="image">
                    <img src="../assets/images/package1.jpg" alt="">
                </div>
                <div class="content">
                    <h3>Beach</h3>
            ...
            <div class="box">
                <div class="image">
                    <img src="../assets/images/package2.jpg" alt="">
                </div>
                <div class="content">
                    <h3>Shows</h3>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptatibus omnis repellat
            ...
            <div class="box">
                <div class="image">
                    <img src="../assets/images/package3.jpg" alt="">
                </div>
                <div class="content">
                    <h3>Places</h3>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptatibus omnis repellat
    ...
    <!--Home Our Services Starts-->
    <section class="home-services">
        <h1 class="heading-title">Our Services</h1>

        <div class="service-container">
            <div class="service-box">
                <h3 class="">Accomodation</h3>
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Magnam ipsum deserunt quas cum quae numquam optio? Nisi a est aspernatur sequi similique voluptas nemo et voluptate neque officia, accusamus voluptatem.</p>
            </div>
        ...
        <div class="text-center"><a href="about.php" class="btn">read more</a></div>

    </section>
    <!--Home Our Services Ends-->
